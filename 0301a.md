...
The location of _perl_ is easy since we specified it: /opt/perl/ bin/5.8.0. Make sure that PERL5LIB is unset and execute _/opt/perl/ bin/5.8.0/perl -V_. Again, we are only interested in the tail; see [Example 5](0301ae5.md).
...
The last lines in perl.sh should set the default Perl environment. [Example 6](0301ae6.md) shows the specifics of our installation.
